...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/data_gen_drone.pdf}
    \caption{Conical LiDAR mounted on mothership drone for intruder-UAV data acquisition and detection. All drones are equipped with GPS sensors for global positioning. Each of them receives RTK corrections from a ground station to enable ground-truth trajectory logging for point cloud labeling.}
